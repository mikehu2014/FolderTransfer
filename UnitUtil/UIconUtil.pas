...
uses Controls, ShellAPI, SysUtils, Windows, Graphics, Forms, UMyUtil, Classes, IniFiles;
...
type
  ...
  public
    ...
    class function getSpace : Integer;
    class function getDot : Integer;
  protected
    class function getImageListName : string;override;
  end;
...
const
  ...
  ShellTranAction_Space = 12;
  ShellTranAction_Dot = 13;
...
begin
  ...
  try
    SysIL32 := SHGetFileInfo('', 0, SFI32, SizeOf(SFI32),
...
begin
  Result := MyAppDataUtil.get + AppFolderName_Resources;
  Result := MyFilePath.getPath( Result );
end;
...
class function MyShellTransActionIconUtil.getDot: Integer;
begin
  Result := getShellIcon( ShellTranAction_Dot );
end;
...
class function MyShellTransActionIconUtil.getSpace: Integer;
begin
  Result := getShellIcon( ShellTranAction_Space );
end;
